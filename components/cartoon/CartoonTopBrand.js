...
export default function CartoonTopBrand() {
  return (
    <div className="ctb" aria-label="NeuroCine Quantum Cartoon">
      <style jsx>{`
        .ctb{width:100%;min-width:0;height:64px;display:grid;grid-template-columns:48px minmax(0,1fr);align-items:center;gap:10px;border:1px solid rgba(0,212,255,.18);border-radius:18px;padding:7px 14px 7px 7px;overflow:hidden;background:linear-gradient(135deg,rgba(5,8,20,.86),rgba(12,8,32,.76));box-shadow:inset 0 1px 0 rgba(255,255,255,.06),0 8px 24px rgba(0,0,0,.15)}
