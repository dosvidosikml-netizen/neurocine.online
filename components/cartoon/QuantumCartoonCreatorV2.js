...
function reducer(s, a) {
  ...
  if (a.type === "localStoryboard") return { ...s, script: a.script ?? s.script, heroes: s.heroes.length ? s.heroes : inferHeroes({ ...s, script: a.script ?? s.script }), scenes: buildScenes(s, a.script), selected: 0, serverProject: null, busy: false, status: a.status || "STORYBOARD ЛОКАЛЬНО" };
