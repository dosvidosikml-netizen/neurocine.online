...
function StudioShellSkin() {
  return (
    <style jsx global>{`
      ...
      .setup-grid-v40,
      .setup-options-v40,
      .setup-main-v40 { min-width: 0 !important; max-width: 100% !important; }
      .setup-v40 .setup-options-v40 .setup-block-v40:has(.setup-style-grid-v40) { overflow: hidden !important; max-width: 100% !important; min-width: 0 !important; padding-right: 0 !important; }
      .setup-v40 .setup-options-v40 .setup-block-v40 .setup-style-grid-v40,
      .setup-style-grid-v40 {
        display: flex !important; flex-direction: row !important; flex-wrap: nowrap !important; grid-template-columns: none !important; align-items: stretch !important; gap: 14px !important; width: 100% !important; max-width: 100% !important; min-width: 0 !important; overflow-x: auto !important; overflow-y: hidden !important; padding: 4px 0 18px !important; scroll-snap-type: x proximity; scroll-padding-left: 0; -webkit-overflow-scrolling: touch; touch-action: pan-x pan-y; overscroll-behavior-x: contain; scrollbar-width: thin; isolation: isolate;
      }
      ...
      .setup-style-grid-v40 button {
        flex: 0 0 168px !important; width: 168px !important; max-width: 168px !important; min-width: 168px !important; min-height: 204px !important; border-radius: 22px !important; padding: 118px 14px 35px !important; position: relative !important; overflow: hidden !important; text-align: left !important; scroll-snap-align: start; white-space: normal !important; line-height: 1.08 !important; background: linear-gradient(180deg, rgba(255,255,255,.075), rgba(255,255,255,.025)) !important; border: 1px solid rgba(255,255,255,.12) !important; box-shadow: inset 0 1px 0 rgba(255,255,255,.06), 0 12px 34px rgba(0,0,0,.20) !important; z-index: 1 !important; cursor: pointer !important; -webkit-tap-highlight-color: rgba(255,138,76,.18);
      }
      .setup-v40 .setup-style-grid-v40 button::before,
      .setup-style-grid-v40 button::before { content: ""; position: absolute; left: 10px; right: 10px; top: 10px; height: 92px; border-radius: 16px; border: 1px solid rgba(255,255,255,.10); box-shadow: inset 0 0 0 1px rgba(0,0,0,.20); pointer-events: none; }
      .setup-v40 .setup-style-grid-v40 button::after,
      .setup-style-grid-v40 button::after { content: "STYLE DNA · VISUAL LOCK"; position: absolute; left: 14px; right: 14px; bottom: 12px; color: rgba(255,255,255,.42); font-size: 9px; font-weight: 900; letter-spacing: .11em; line-height: 1.25; pointer-events: none; }
      .setup-v40 .setup-style-grid-v40 button:nth-child(1)::before, .setup-style-grid-v40 button:nth-child(1)::before { background: radial-gradient(circle at 34% 18%, rgba(255,255,255,.55), transparent 11%), linear-gradient(0deg, rgba(10,11,14,.42), rgba(10,11,14,.1)), linear-gradient(135deg,#10131b,#2b2f38 48%,#0b0d10); }
      .setup-v40 .setup-style-grid-v40 button:nth-child(2)::before, .setup-style-grid-v40 button:nth-child(2)::before { background: linear-gradient(90deg, transparent 0 44%, rgba(255,255,255,.16) 45% 48%, transparent 49%), radial-gradient(circle at 75% 22%, rgba(150,0,0,.62), transparent 24%), linear-gradient(135deg,#080609,#2b0a0f 58%,#050507); }
      .setup-v40 .setup-style-grid-v40 button:nth-child(3)::before, .setup-style-grid-v40 button:nth-child(3)::before { background: linear-gradient(105deg, transparent 0 28%, rgba(255,255,255,.15) 29% 33%, transparent 34%), radial-gradient(circle at 62% 38%, rgba(210,30,20,.50), transparent 18%), linear-gradient(135deg,#0a0b0f,#211014 44%,#040405); }
      .setup-v40 .setup-style-grid-v40 button:nth-child(4)::before, .setup-style-grid-v40 button:nth-child(4)::before { background: linear-gradient(0deg, rgba(50,40,22,.45), transparent 46%), radial-gradient(circle at 22% 34%, rgba(230,190,80,.45), transparent 20%), linear-gradient(135deg,#14120c,#4b321a 54%,#10100d); }
      .setup-v40 .setup-style-grid-v40 button:nth-child(5)::before, .setup-style-grid-v40 button:nth-child(5)::before { background: linear-gradient(90deg, rgba(255,0,120,.25), transparent 18%, transparent 74%, rgba(0,200,255,.25)), radial-gradient(circle at 34% 25%, rgba(255,0,210,.60), transparent 20%), linear-gradient(135deg,#090015,#1d0b47 50%,#002f43); }
      .setup-v40 .setup-style-grid-v40 button:nth-child(6)::before, .setup-style-grid-v40 button:nth-child(6)::before { background: linear-gradient(0deg, rgba(255,90,190,.28) 0 18%, transparent 19%), linear-gradient(90deg, rgba(0,255,255,.22), transparent, rgba(255,0,170,.22)), linear-gradient(135deg,#13002b,#2b1445 52%,#071c37); }
      .setup-v40 .setup-style-grid-v40 button:nth-child(7)::before, .setup-style-grid-v40 button:nth-child(7)::before { background: linear-gradient(90deg, transparent 0 48%, rgba(0,255,255,.35) 49% 52%, transparent 53%), radial-gradient(circle at 72% 22%, rgba(255,0,128,.5), transparent 20%), linear-gradient(135deg,#02111a,#092a3c 48%,#1d0229); }
      .setup-v40 .setup-style-grid-v40 button:nth-child(8)::before, .setup-style-grid-v40 button:nth-child(8)::before { background: repeating-linear-gradient(0deg, rgba(255,255,255,.10) 0 1px, transparent 1px 5px), linear-gradient(135deg,#090909,#252525 47%,#050505); }
      .setup-v40 .setup-style-grid-v40 button:nth-child(9)::before, .setup-style-grid-v40 button:nth-child(9)::before { background: radial-gradient(circle at 32% 26%, rgba(255,235,180,.55), transparent 21%), linear-gradient(135deg,#20170d,#5a391d 44%,#090705); }
      .setup-v40 .setup-style-grid-v40 button:nth-child(n+10)::before, .setup-style-grid-v40 button:nth-child(n+10)::before { background: radial-gradient(circle at 28% 25%, rgba(255,255,255,.25), transparent 20%), radial-gradient(circle at 76% 40%, rgba(120,80,255,.34), transparent 24%), linear-gradient(135deg,#0b0c12,#26233b 52%,#050507); }
      .setup-v40 .setup-style-grid-v40 button.active,
      .setup-style-grid-v40 button.active { border-color: rgba(255,138,76,.88) !important; background: linear-gradient(180deg, rgba(255,138,76,.18), rgba(255,255,255,.035)) !important; box-shadow: 0 0 0 1px rgba(255,138,76,.22), 0 18px 44px rgba(255,92,42,.16) !important; }
      .setup-v40 .setup-style-grid-v40 button.active::after,
      .setup-style-grid-v40 button.active::after { content: "SELECTED · DIRECTOR LOCK"; color: rgba(255,214,186,.78); }
      @media (max-width: 760px) {
        ...
        .setup-v40, .setup-grid-v40, .setup-options-v40, .setup-main-v40, .setup-v40 .setup-options-v40 .setup-block-v40 { min-width: 0 !important; max-width: 100% !important; overflow-x: hidden !important; }
        .setup-v40 .setup-options-v40 .setup-block-v40:has(.setup-style-grid-v40) { width: 100% !important; max-width: 100% !important; padding-inline: 14px !important; overflow: hidden !important; }
        .setup-v40 .setup-style-grid-v40, .setup-style-grid-v40 { width: 100% !important; max-width: 100% !important; margin-inline: 0 !important; padding-inline: 0 !important; overflow-x: auto !important; overflow-y: hidden !important; }
        .setup-v40 .setup-style-grid-v40 button, .setup-style-grid-v40 button { flex-basis: 154px !important; width: 154px !important; max-width: 154px !important; min-width: 154px !important; min-height: 190px !important; padding: 108px 12px 35px !important; font-size: 14px !important; }
        .setup-v40 .setup-style-grid-v40 button::before, .setup-style-grid-v40 button::before { height: 84px !important; }
