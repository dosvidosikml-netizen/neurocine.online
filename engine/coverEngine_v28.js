...
export function detectCoverTheme(input = {}) {
  ...
  if (hasAny(source, ["петров", "ссср", "советск", "бункер", "сирен", "ложная тревога", "ложн", "спутник", "солнечный блик", "не нажал", "конца мира", "до конца мира", "компьютеры показали"])) return "cold_war_alert";
