...
function isRawSceneBeat(value = "") {
  ...
  if (/\d|%|€|\$|год|лет|век|млн|миллион|миллиард|статус|ритуал|сл[её]з|плат|стоил|скры|запрет|система|алгоритм|свидетел|документ|улика|тревог|сигнал|приказ|эксперимент|смерть|выжил|исчез/i.test(text)) {
    return false;
  }
