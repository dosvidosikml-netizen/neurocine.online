...
const LOADING_TIPS = [
  ...
  { icon: "🎨", text: "Движок DARK HISTORY даёт самые жёсткие результаты в Grok. CINEMATIC — для Veo 3." },
  ...
  { icon: "🌫", text: "Volumetric fog + chiaroscuro = самый кинематографичный результат в Veo. Проверено." },
  ...
  { icon: "🎭", text: "X-Ray движок идеален для научных тем. Grok генерирует нейроны, атомы, ДНК лучше всего." },
...
━━━ ДИРЕКТОРСКИЙ МАНИФЕСТ — GOD MODE ━━━

ПРИНЦИП 1 — KUBRICK'S RULE: Каждый кадр должен быть НЕВОЗМОЖЕН к улучшению. Если кадр можно сделать более тревожным, более красивым или более шокирующим — переделай его. Никакой поблажки себе.

ПРИНЦИП 2 — TARANTINO'S REVERSE: Лучший момент сцены — НЕ в конце. Покажи кульминацию в начале, затем объясни КАК мы сюда пришли. Зритель уже знает финал — и всё равно не может оторваться.

ПРИНЦИП 3 — FINCHER'S DREAD: Ужас не в крови — в ДЕТАЛЯХ перед действием. Капля воды собирается медленнее обычного. Тень на стене стала длиннее. Тишина слишком длинная. Вот настоящий страх.

ПРИНЦИП 4 — NOLAN'S CLOCK: В каждой сцене должен тикать невидимый таймер. Зритель должен физически чувствовать: что-то произойдёт через 3... 2... 1... Даже в спокойных кадрах.

ПРИНЦИП 5 — THE IMPOSSIBLE FRAME: Каждый третий кадр должен показывать то, что физически невозможно снять камерой: POV внутри черепа, замедление на уровне молекул, вид с орбиты на одного человека. Зритель должен думать "как это вообще сняли?"
...
5. FINCHER'S DEAD SECOND: Каждые 7-8 кадров вставляй 1 кадр почти полной тишины и статики — 1.5 секунды. После него следующий удар ощущается в 3 раза сильнее.
...
25. KUBRICK SELF-CHECK: Перед финальным выводом перечитай каждый кадр. Если retention_score < 80 — переделай 3 самых слабых кадра. Не выдавай результат с оценкой ниже 80.
