...
7. AUTO-DETECT CHARACTERS (CRITICAL RULES):
   ...
   B) Для каждого персонажа создай ДВА поля:
      ...
      — "ref_sheet_prompt": используй ТОЧНО этот шаблон (подставляй физику в [PHYSICAL_DESC]):
        "Nine-panel film costume and makeup continuity test photography of a real actor. Shot on 35mm Kodak Vision3 film, photorealistic, RAW photograph, no CGI, no 3D render, no game engine, no Unreal Engine, no digital art, no illustration, no anime, no painting, no text, no labels, no arrows. Subject: [PHYSICAL_DESC]. STUDIO: neutral mid-grey seamless paper background, soft diffused overhead key light + subtle fill, no dramatic shadows, consistent lighting across all panels. LAYOUT: three rows. TOP ROW — four full-body standing views, equal spacing: front facing camera, left side profile, right side profile, back view. MIDDLE ROW — four 3/4 body shots same order: front 3/4 left, left 3/4, right 3/4, back 3/4. BOTTOM ROW — three head-and-shoulders portraits: front, left profile, right profile. CRITICAL: identical real human face, real skin texture, visible pores, stubble, micro-imperfections, film grain ISO 400, subsurface scattering. Every panel same person same costume. (CGI:1.6),(3D render:1.6),(game asset:1.6),(Unreal:1.6),(cartoon:1.5),(digital art:1.5),(smooth skin:1.4),(illustration:1.5) —no"
...
- For each character generate TWO fields:
  ...
  2. "ref_sheet_prompt": use EXACTLY this template filling [PHYSICAL_DESC] with the same info as dna without brackets:
     "Nine-panel film costume and makeup continuity test photography of a real actor. Shot on 35mm Kodak Vision3 film, photorealistic, RAW photograph, no CGI, no 3D render, no game engine, no Unreal Engine, no digital art, no illustration, no anime, no painting, no text, no labels, no arrows. Subject: [PHYSICAL_DESC]. STUDIO: neutral mid-grey seamless paper background, soft diffused overhead key light + subtle fill, no dramatic shadows, consistent lighting across all panels. LAYOUT: three rows. TOP ROW — four full-body standing views equal spacing: front, left profile, right profile, back. MIDDLE ROW — four 3/4 body shots: front 3/4, left 3/4, right 3/4, back 3/4. BOTTOM ROW — three head-and-shoulders portraits: front, left profile, right profile. CRITICAL: identical real human face, visible pores, stubble, micro-imperfections, film grain ISO 400, subsurface scattering. (CGI:1.6),(3D render:1.6),(game asset:1.6),(Unreal:1.6),(cartoon:1.5),(smooth skin:1.4),(illustration:1.5) —no"
