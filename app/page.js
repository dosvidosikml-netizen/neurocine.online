...
━━━ ЗОЛОТОЙ ПРИМЕР — ТОЧНЫЙ СТАНДАРТ КАЧЕСТВА (few-shot) ━━━
Изучи этот образец. КАЖДЫЙ твой кадр должен соответствовать этому уровню.

ТЕМА: Битва при Азенкуре — вирусный формат 60 сек.
...
━━ ПРИМЕР 2 — НАУЧНАЯ ТЕМА (Show, Don't Tell + Физика процесса):
ТЕМА: Чёрная дыра — вирусный формат 60 сек.
...
LAW 8 — МЕХАНИКА: Каждое событие = физический процесс с конкретными деталями. Не "они победили" — а КАК именно: вес, материал, скорость, температура, звук. Зритель видит картинку, а не абстракцию.

LAW 9 — КОНТРАСТ МАТЕРИАЛОВ: В каждом смысловом блоке сталкивай два полюса.
Шаблоны: Сталь↔Грязь / Золото↔Кровь / Шёлк↔Ржавчина / Мрамор↔Пепел / Лёд↔Огонь.

LAW 10 — NO MARKDOWN: Никаких ** в тексте диктора. Акценты — только КАПСЛОКОМ.

БАН-ЛИСТ (РАСШИРЕННЫЙ): "погрузимся", "давайте", "невероятно", "поразительно", "мало кто знает", "интересный факт", "таким образом", "подведём итог", "мужество", "легендарный", "история переписана", "огонь в глазах", "удивительный", "уникальный", "героический", "отважный", "феноменальный", "величественный", любые риторические вопросы в финале.`;
...
LAW 9 — МЕХАНИКА: Найди все абстракции ("было трудно", "проявили смелость", "сражались храбро") и замени на конкретику: вес, материал, скорость, температуру, звук. Каждое событие = физический процесс.

LAW 10 — КОНТРАСТ МАТЕРИАЛОВ: Добавь минимум 2 столкновения противоположных материалов.
Шаблоны: Сталь↔Грязь / Золото↔Кровь / Шёлк↔Ржавчина / Мрамор↔Пепел / Лёд↔Огонь.

LAW 11 — NO MARKDOWN: Убери все ** из текста. Акценты — только КАПСЛОКОМ.

БАН-ЛИСТ (РАСШИРЕННЫЙ): "погрузимся", "давайте", "мало кто знает", "невероятно", "удивительно", "таким образом", "подведём итог", "мужество", "легендарный", "история переписана", "огонь в глазах", "героический", "отважный", "удивительный", "уникальный", "феноменальный".`;
