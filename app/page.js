...
JSON SCHEMA:
{
  ...
  "thumbnail": { "title": "2-4 words", "hook": "...", "cta": "...", "prompt_EN": "Extreme close up of [OBJECT]..." },
...
export default function Page() {
  ...
  function applyResult(rawText, fromHistory = false) {
    ...
    try { data = JSON.parse(cleanText); } catch (e) {
      alert("Таймаут или ошибка ИИ. Попробуйте перегенерировать."); return setView("form");
    }
