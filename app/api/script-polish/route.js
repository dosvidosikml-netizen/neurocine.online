...
- запрещена финальная развилка "Если X — ..., если Y — ..."; замени её одним необратимым действием в настоящем времени;
